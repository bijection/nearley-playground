...
let default_playground_state = {
    ...
    tabs: [
        ...
        {
            name: 'Moo Example',
            editor_value: mooexample,
            errors: '',
            tests: ['6 * 7', '1 times 9', 'sin 42'],
        },
    ],
}
...
class Playground extends Component {
    ...
    deleteTab(e, i) {
        ...
        if (state.tabs.length < 2) {
            ...
            state.active =
                state.active <= i ? Math.min(state.active, state.tabs.length - 1) : state.active - 1
        ...
        return (
            <div className="playground">
                ...
                <div className="tabs">
                    ...
                    <div className="add" onClick={this.addTab.bind(this)}>
                        + Add Tab
                    </div>
