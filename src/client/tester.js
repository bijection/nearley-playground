...
import gen from 'nearley/lib/unparse'
...
export default class Tester extends Component {
    ...
    genTest() {
        ...
        let example = gen(grammar, grammar.ParserStart, 10)
        let { tests } = this.props
        ...
        return (
            ...
            >
                ...
                <div className="test-create">
                    <div className="test-add" onClick={this.addTest.bind(this)}>
                        + Add Test
                    </div>
                    <div className="test-generate" onClick={this.genTest.bind(this)}>
                        Generate
                    </div>
                </div>
            </div>
...
class Test extends Component {
    ...
    keyDown(e) {
        if (e.key === 'Backspace' && e.target.value === '') this.props.deleteTest(true)
    }
    runTest(t) {
        this.setState({
            testingTest: t,
